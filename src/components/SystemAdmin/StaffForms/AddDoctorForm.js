  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                onChange={handleInputChange}
                className={`w-full pl-10 pr-3 py-2 border rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent ${
                  errors.medicalDegree ? 'border-red-500' : 'border-gray-300'
                }`}
      ...
      <div className="flex items-center justify-end space-x-3 pt-6 border-t border-gray-200">
        ...
        <button
          type="submit"
          className="px-6 py-2 bg-gradient-to-r from-teal-500 to-teal-600 text-white rounded-lg hover:from-teal-600 hover:to-teal-700 transition-all"
        >
          Add Doctor
        </button>
      </div>
