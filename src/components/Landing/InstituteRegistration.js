...
const InstituteRegistration = ({ onBack, onComplete }) => {
  ...
  const instituteTypes = [
    {
      ...
      description:
        "For clinics and medical centers providing outpatient care services",
    ...
    },
    {
      ...
      description:
        "For diagnostic labs, pathology centers, and medical testing facilities",
  ...
  const selectedTypeData = instituteTypes.find(
            ...
            >
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
                {instituteTypes.map((institute, index) => (
                  ...
                  >
                    <div
                      className={`w-20 h-20 bg-gradient-to-br ${institute.color} rounded-2xl flex items-center justify-center text-white mb-6 mx-auto`}
                    >
                      {React.cloneElement(institute.icon, {
                        className: "w-10 h-10",
                      })}
                    </div>
                ...
                <div className="flex items-center justify-between mb-4">
                  ...
                  {selectedTypeData && (
                    <div className="flex items-center space-x-3">
                      <div
                        className={`w-10 h-10 bg-gradient-to-br ${selectedTypeData.color} rounded-lg flex items-center justify-center text-white`}
                      >
                        {React.cloneElement(selectedTypeData.icon, {
                          className: "w-6 h-6",
                        })}
                      </div>
                      <div>
                ...
                <div className="flex space-x-4 pt-6">
                  <motion.button
                    ...
                    className={`flex-1 bg-gradient-to-r ${
                      selectedTypeData?.color || "from-teal-500 to-teal-600"
                    } text-white py-4 px-6 rounded-lg font-semibold transition-all duration-200 flex items-center justify-center space-x-2 ${
                      isSubmitting
          ...
          {currentStep === "confirmation" && (
            ...
            >
              ...
              <p className="text-xl text-gray-600 mb-6">
                Welcome to the MediLink ecosystem! Your{" "}
                {selectedTypeData?.title.toLowerCase()} registration has been
                submitted.
              </p>
              ...
              <div className="bg-gray-50 rounded-lg p-6 mb-8">
                ...
                <div className="space-y-3 text-left">
                  ...
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      You'll receive an email confirmation with setup
                      instructions
                    </span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Our support team will contact you to schedule onboarding
                    </span>
                  </div>
                  <div className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5 flex-shrink-0" />
                    <span className="text-gray-600">
                      Access credentials will be sent to the administrator email
                    </span>
                  </div>
                </div>
              </div>
