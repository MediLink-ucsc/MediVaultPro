      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-orange-500 transition-colors duration-200"
          >
            <option value="Day Shift (7:00 AM - 7:00 PM)">
              Day Shift (7:00 AM - 7:00 PM)
            </option>
            <option value="Night Shift (7:00 PM - 7:00 AM)">
    ...
    <div className="space-y-6">
      <div className="space-y-4">
        {Object.entries(settings.notifications).map(([key, value]) => {
          const descriptions = {
            patientAlerts:
              "Receive immediate notifications for patient status changes",
            medicationReminders:
              "Get reminders for medication administration times",
            shiftReminders:
              "Receive notifications about upcoming shift changes",
            systemAlerts: "Receive system maintenance and error alerts",
            emergencyAlerts:
              "Get notified immediately for emergency situations",
          ...
          return (
            <div
              key={key}
              className="flex items-center justify-between p-5 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors duration-200"
            >
      ...
      <div className="flex items-center justify-between p-5 bg-gray-50 rounded-lg">
        <div>
          ...
          <p className="text-sm text-gray-600">
            Automatically refresh patient data at set intervals
          </p>
        </div>
      ...
      <div className="max-w-6xl mx-auto p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your assistant profile, preferences and configurations
          </p>
        </div>
